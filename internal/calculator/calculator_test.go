...
func TestCalculatePricing(t *testing.T) {
	cases := []struct {
		...
		{"Fable 5 input", "claude-fable-5", TokenUsage{InputTokens: 1_000_000}, 10.00},
		{"Fable 5 output", "claude-fable-5", TokenUsage{OutputTokens: 1_000_000}, 50.00},
		{"Fable 5 cache read", "claude-fable-5", TokenUsage{CacheReadTokens: 1_000_000}, 1.00},
		{"Fable 5 5m cache write", "claude-fable-5", TokenUsage{CacheWrite5mTokens: 1_000_000}, 12.50},
		{"Fable 5 1h cache write", "claude-fable-5", TokenUsage{CacheWrite1hTokens: 1_000_000}, 20.00},
		{"Mythos 5 input", "claude-mythos-5", TokenUsage{InputTokens: 1_000_000}, 10.00},
		{"Mythos 5 output", "claude-mythos-5", TokenUsage{OutputTokens: 1_000_000}, 50.00},
		...
		{"Sonnet 5 input", "claude-sonnet-5", TokenUsage{InputTokens: 1_000_000}, 2.00},
		{"Sonnet 5 output", "claude-sonnet-5", TokenUsage{OutputTokens: 1_000_000}, 10.00},
		{"Sonnet 5 cache read", "claude-sonnet-5", TokenUsage{CacheReadTokens: 1_000_000}, 0.20},
		{"Sonnet 5 5m cache write", "claude-sonnet-5", TokenUsage{CacheWrite5mTokens: 1_000_000}, 2.50},
		{"Sonnet 5 1h cache write", "claude-sonnet-5", TokenUsage{CacheWrite1hTokens: 1_000_000}, 4.00},
